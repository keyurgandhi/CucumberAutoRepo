...
@CucumberOptions(
		...
		features = {"src/test/resource/com/basic/backgroundFF/"},
		glue = {"com/basic/backgroundSD/"},   // path/package for step definition file
		plugin= {"pretty",
				"html:target/cucumber-htmlreport",
				"json:target/cucumber-report1.json",
				"com.vimalselvam.cucumber.listener.ExtentCucumberFormatter:target/ExtentReport1.html"}
		)
public class RunMyBackgroundMultipleScenarioFeatureTest {
